...
moduleForComponent('euic-slide-menu', 'Integration | Component | euic slide menu', {
  integration: true,
  beforeEach: function () {
...
test('it renders', function(assert) {
  assert.expect(1);
  this.render(hbs`{{euic-slide-menu lookup=lookup}}`);
...
test('menuPosition - default', function(assert) {
  assert.expect(1);
  this.render(hbs`{{euic-slide-menu}}`);
...
test('menuPosition left and right', function(assert) {
  ...
  this.render(hbs`{{euic-slide-menu menuPosition=menuPosition}}`);
  assert.equal(this.$('div.euic-slide-menu.left').length, 1);
...
test('pushContent', function (assert) {
  ...
  this.render(hbs`{{euic-slide-menu pushContent=pushContent}}`);
...
test('maskContent', function (assert) {
  ...
  this.render(hbs`{{euic-slide-menu maskContent=maskContent}}`);
...
test('showDefaultToggle', function (assert) {
  ...
  this.render(hbs`{{euic-slide-menu showDefaultToggle=showDefaultToggle}}`);
...
test('menuOpenChanged', function (assert) {
  ...
  this.render(hbs`{{euic-slide-menu menuOpen=menuOpen}}`);
